...
assert.strictEqual(toTitleCase(title1), outputTitle1);

const title2 =
  "knitting with dog hair: better a sweater from a dog you KNOW and LOVE than from a sheep you’ll NEVER meet";
const outputTitle2 =
  "Knitting With Dog Hair: Better A Sweater From A Dog You Know And Love Than From A Sheep You’ll Never Meet";
assert.strictEqual(toTitleCase(title2), outputTitle2);
